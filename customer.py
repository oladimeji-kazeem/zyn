...
# with st.tabs(["Sales Insights", "Customer Insights", "Product Insights", "Customer Segmentation", "CLV Prediction", "Sales Forecasting"]) as (tab1, tab2, tab3, tab4, tab5, tab6, tab7):
    with tab7:
        st.subheader("Sales Forecasting for the Next Year")
        ...
        # Create future dates dataframe for the next 12 months
        ...
        fig_monthly.update_layout(title="Monthly Sales Forecast", xaxis_title="Date", yaxis_title="Sales Amount")
        ...
        fig_quarterly = px.bar(quarterly_forecast, x='quarter', y='yhat', title="Quarterly Sales Forecast")
        ...
        fig_half_year = px.bar(half_year_forecast, x='half_year', y='yhat', title="Half-Yearly Sales Forecast")
        ...
        fig_annual = px.bar(annual_forecast, x='year', y='yhat', title="Annual Sales Forecast")
        fig_annual.update_layout(xaxis_title="Year", yaxis_title="Predicted Sales")
        st.plotly_chart(fig_annual, use_container_width=True)

        # Interpretation of Sales Forecast
        with st.expander("Understanding Sales Forecasting"):
            st.write("""
            **Sales Forecasting** is a predictive analytics technique that estimates future sales based on historical data, seasonality, and trends. Accurate sales forecasting can benefit the business in several ways:

            1. **Inventory Management**:
                - Knowing expected sales helps optimize inventory levels, preventing stockouts or overstocking, especially during peak demand periods.

            2. **Budgeting and Financial Planning**:
                - Sales forecasts provide a basis for revenue projections, which can guide budget allocations, hiring plans, and investment decisions.

            3. **Marketing and Promotions Planning**:
                - Forecasts allow marketing teams to prepare for high-sales periods with appropriate campaigns, while also identifying slower periods that may need promotional boosts.

            4. **Strategic Decision Making**:
                - Long-term sales trends support strategic planning for expansion, resource allocation, and product development, helping the business stay competitive and aligned with market demand.
